...
TAGGER_MODEL_HINTS = {
    "wd-eva02-large-tagger-v3": {
        ...
        "safe_mode_note": "Adaptive runtime keeps GPU throughput high first, then falls back automatically if the run becomes unstable.",
        "gpu_default": True,
        "gpu_confirmation_required": True,
        "gpu_locked": False,
    ...
    "toriigate-0.5": {
        ...
        "gpu_confirmation_required": True,
        "gpu_locked": False,
        "runtime_note": "Runs through the dedicated Transformers VLM backend instead of the WD14 ONNX runtime. GPU is strongly recommended.",
        "quality_score": 5,
        "speed_score": 1,
        "stability_score": 2,
    },
