...
RECOMMENDED_MODELS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "size_gb": 3.0,
        "vram_min_gb": 4,
        "description": "Google Gemma 3 4B - fast, small, vision-capable, good for low VRAM",
        "nsfw_ok": True,
    },
    {
        "id": "gemma4:e2b",
        ...
        "size_gb": 7.2,
        "vram_min_gb": 5,
        "description": "Google Gemma 4 E2B - vision+audio, 128K context, fast edge model",
        "nsfw_ok": True,
    },
    {
    ...
    {
        "id": "gemma4:26b",
        "name": "Gemma 4 26B (MoE A4B)",
        "size_gb": 18.0,
        "vram_min_gb": 12,
        "description": "Google Gemma 4 26B - native vision, MoE (4B active), 256K context, excellent quality",
        "nsfw_ok": True,
    },
    {
        "id": "prutser/gemma-4-26B-A4B-it-ara-abliterated",
        "name": "Gemma 4 26B Uncensored",
        "size_gb": 18.0,
        "vram_min_gb": 12,
