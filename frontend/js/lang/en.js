...
window.I18nLang_en = {
    ...
    'autosep.previewHint': 'Preview now shows every match found by the current filters.',
    ...
    'tagger.customModelHelpGpuPreferred': 'Custom ONNX model. GPU Preferred is active because a compatible provider is available. CPU Safe Mode is still safer if stability is unknown.',
    ...
    'tagger.gpuHelpCustomCpu': 'CPU Safe Mode is active for the custom model. Switch back to GPU Preferred if you need more speed and the model stays stable.',
    ...
    'queueSolitaire.filterHelp': 'Search tags or prompt keywords, then move matching images into a section.',
    'queueSolitaire.searchLabel': 'Tag / Prompt',
    'queueSolitaire.useGalleryFilters': 'Use Gallery Filters',
    ...
    'queueSolitaire.filterSummaryIdle': 'No queue filters active yet.',
    'queueSolitaire.filterSummaryQuick': 'Quick queue filters',
    'queueSolitaire.filterSummaryAdvanced': 'Advanced queue filters',
    'queueSolitaire.filterSummaryGallery': 'Using Gallery filters',
