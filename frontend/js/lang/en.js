...
window.I18nLang_en = {
    ...
    'censor.queueSubtitle': 'Drag to reorder \u2022 Click to edit',
    ...
    'censor.legacyYolo': 'Legacy YOLO (Default)',
    'censor.nudenet': 'NudeNet v3',
    'censor.both': 'Both (NudeNet + Legacy)',
    ...
    'similar.guideStep1': 'Creates visual fingerprints for all images (first time downloads ~200MB model)',
    ...
    'artist.huggingface': 'HuggingFace (Default)',
    'artist.modelscope': 'ModelScope (China)',
    'artist.localModel': 'Local Model',
    'artist.localModelPath': 'Local Model Path',
    'artist.confidenceThreshold': 'Confidence Threshold',
    'artist.belowThreshold': 'Below this = "undefined"',
