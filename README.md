...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.3.4-ff8a00" alt="Version">
...
<p align="center">
  <a href="https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-windows-portable.zip"><b>Download for Windows</b></a>
  ·
  <a href="https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-linux-portable-x86_64.tar.gz"><b>Linux x86_64 (portable)</b></a>
  ·
  <a href="https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-linux-portable-aarch64.tar.gz"><b>Linux aarch64 (portable)</b></a>
  ·
  <a href="https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-linux.tar.gz">Linux (source)</a>
  ·
...
1. 下载 [sd-image-sorter-v3.3.4-windows-portable.zip](https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-windows-portable.zip)
2. 解压到任意目录
...
- **x86_64**（一般 PC、Intel/AMD 桌面/笔电、Steam Deck、传统 x86 服务器）
  下载 [sd-image-sorter-v3.3.4-linux-portable-x86_64.tar.gz](https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-linux-portable-x86_64.tar.gz)（约 80 MB）
- **aarch64 / arm64**（Raspberry Pi 4 / 5、ARM Linux 服务器、AWS Graviton、Apple Silicon 在 Linux 下）
  下载 [sd-image-sorter-v3.3.4-linux-portable-aarch64.tar.gz](https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-linux-portable-aarch64.tar.gz)（约 75 MB）

解压并执行（指令一样，看你下哪个 tarball）：

```bash
# 例如 x86_64
tar xzf sd-image-sorter-v3.3.4-linux-portable-x86_64.tar.gz
cd sd-image-sorter
...
1. 下载 [sd-image-sorter-v3.3.4-linux.tar.gz](https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-linux.tar.gz)
2. 解压并执行：

```bash
tar xzf sd-image-sorter-v3.3.4-linux.tar.gz
cd sd-image-sorter
chmod +x run.sh
./run.sh
```
...
1. Download [sd-image-sorter-v3.3.4-windows-portable.zip](https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.3.4-windows-portable.zip)
