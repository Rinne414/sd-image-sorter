...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.1.5-ff8a00" alt="Version">
...
<p align="center">
  <a href="https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.1.5-windows-portable.zip"><b>Download for Windows</b></a>
  ·
  <a href="https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.1.5-linux.tar.gz"><b>Download for Linux</b></a>
  ·
...
1. 下载 [sd-image-sorter-v3.1.5-windows-portable.zip](https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.1.5-windows-portable.zip)
2. 解压到任意目录
...
1. 下载 [sd-image-sorter-v3.1.5-linux.tar.gz](https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.1.5-linux.tar.gz)
2. 解压并执行：

```bash
tar xzf sd-image-sorter-v3.1.5-linux.tar.gz
cd sd-image-sorter
chmod +x run.sh
./run.sh
```
...
1. Download [sd-image-sorter-v3.1.5-windows-portable.zip](https://github.com/peter119lee/sd-image-sorter/releases/latest/download/sd-image-sorter-v3.1.5-windows-portable.zip)
